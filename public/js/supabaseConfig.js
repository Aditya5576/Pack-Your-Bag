...
window.SUPABASE_ANON_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InltYmlmbnBoc3p0dHN6dXJhcXJ3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODQwMTI1MDYsImV4cCI6MjA5OTU4ODUwNn0.TFeIuyRsF-IWya46LEtMVz8TyRoADKsdHBToGOZMeFc";
    ...
    try {
      if (typeof supabase !== "undefined") {
        ...
        if (!data.session) {
          ...
          console.log(`Supabase: Active session recovered (${isGuest ? 'Guest/Anon' : 'GitHub Provider'}): `, data.session.user.id);
        }
