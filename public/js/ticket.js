  ...
  appView.innerHTML = `
    <div class="ticket-page-container container">
      ...
      <div class="ticket-invoice-grid">
        ...
        <div class="invoice-card retail-invoice-container" id="printable-retail-invoice" style="background: #ffffff; color: #1e293b; border: 1px solid #e2e8f0; border-radius: var(--radius-md); font-family: 'Plus Jakarta Sans', sans-serif; position: relative; overflow: hidden; padding: 25px; box-shadow: var(--shadow-md);">
          ...
          <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 30px; position: relative; z-index: 2;">
            ...
            <div style="text-align: right;">
              ...
              <p style="font-size: 11px; color: #475569; margin: 4px 0 0 0; font-weight: 700;">Retail Invoice No: REC-${booking.id.split("-")[1]}</p>
